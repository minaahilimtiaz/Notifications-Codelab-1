...
class SnoozeReceiver: BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        /*time since system was booted */
        val triggerTime = SystemClock.elapsedRealtime() + DateUtils.MINUTE_IN_MILLIS

        //update the values of the pending intent if exists
      ...
      /*  create object to notify that an event has happened*/
        val notificationManager = ContextCompat.getSystemService(context,
                NotificationManager::class.java) as NotificationManager

        /*cancel the previous notifications*/
