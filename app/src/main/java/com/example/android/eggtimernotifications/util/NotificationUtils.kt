...
/**
 * Builds, delivers and customize the notification
 *
...
fun NotificationManager.sendNotification(messageBody: String, applicationContext: Context) {
    ...
    // create pending intent for starting an activity
    ...
    val snoozePendingIntent: PendingIntent = PendingIntent.getBroadcast(applicationContext, REQUEST_CODE,
        snoozeIntent, FLAGS)
    ...
    val builder = NotificationCompat.Builder(applicationContext, applicationContext.getString(R.string.egg_notification_channel_id))
        ...
        //intent will be triggered when notification is tapped to open the activity
        //used for default action
        .setContentIntent(contentPendingIntent)
        //cancel the previously shown notifications
        .setAutoCancel(true)
    ...
    //function of Notification Manager to notify
